...
| `base_branch`             | No       | `master`                         | Name of the BaseBranch. The pipeline will only listen to pullrequests that want to merge into the specified branch. The pipeline will listen to every pullrequest if nothin is specified.                          
